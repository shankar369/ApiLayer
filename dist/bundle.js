var Api = function (e) {
    ...
    (function (t) {
        ...
        var s, a = {
            adapter: ("undefined" != typeof XMLHttpRequest ? s = n(3) : void 0 !== t && (s = n(3)), s),
    ...
    var o = n(8),
        i = function () {
            ...
            return t = e, (n = [{
                ...
                value: function (e) {
                    ...
                    this.server.get("/users/", e).then(function (e) {
                        t(e.data)
                    }).catch(function (e) {
                        console.log("err"), n(e)
                    })
                ...
                value: function (e, t) {
                    ...
                    this.server.get("/users/".concat(e), t).then(function (e) {
                        return n(e.data)
                    }).catch(function (e) {
                        return r(e)
                    })
                ...
                value: function (e, t) {
                    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : u,
                        r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : s;
                    this.server.post("/users/", e, t).then(function (e) {
                        return n(e.data)
                    }).catch(function (e) {
                        return r(e)
                    })
                ...
                value: function (e, t) {
                    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : u,
                        r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : s;
                    this.server.delete("/users/".concat(e), e, t).then(function (e) {
                        return n(e.data)
                    }).catch(function (e) {
                        return r(e)
                    })
        ...
        a = new i;
    a.getUsers(), e.exports = a, window.api = a, document.getElementById("div1").innerText = "api.js"
}, function (e, t, n) {
    function r(e, t) {
        for (var n = 0; n < t.length; n++) {
            var r = t[n];
    ...
    e.exports = s, document.getElementById("div2").innerText = "server.js"
}, function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.isNetworkError = s, t.isRetryableError = f, t.isSafeRequestError = l, t.isIdempotentRequestError = p, t.isNetworkOrIdempotentRequestError = d, t.exponentialDelay = m, t.default = v;
    var r, o = n(11),
    ...
    function l(e) {
        return !!e.config && (f(e) && -1 !== a.indexOf(e.config.method))
    }

    function p(e) {
        return !!e.config && (f(e) && -1 !== c.indexOf(e.config.method))
    }
    ...
    function v(e, t) {
        e.interceptors.request.use(function (e) {
            ...
            var o = function (e, t) {
                ...
                f = o.retryDelay,
                l = void 0 === f ? h : f,
                p = o.shouldResetTimeout,
                m = void 0 !== p && p,
                v = E(r);
            if (c(n) && v.retryCount < s) {
                v.retryCount += 1;
                var y = l(v.retryCount, n);
                if (function (e, t) {
                    ...
                    }(e, r), !m && r.timeout && v.lastRequestTime) {
                    var g = Date.now() - v.lastRequestTime;
                    r.timeout = Math.max(r.timeout - g - y, 1)
                }
    ...
    v.isNetworkError = s, v.isSafeRequestError = l, v.isIdempotentRequestError = p, v.isNetworkOrIdempotentRequestError = d, v.exponentialDelay = m, v.isRetryableError = f
}, function (e, t, n) {
    "use strict";
    ...
    }, a.Cancel = n(6), a.CancelToken = n(30), a.isCancel = n(5), a.all = function (e) {
    ...
    o.prototype = new Error, o.prototype.code = 5, o.prototype.name = "InvalidCharacterError", e.exports = function (e) {
        for (var t, n, i = String(e), u = "", s = 0, a = r; i.charAt(0 | s) || (a = "=", s % 1); u += a.charAt(63 & t >> 8 - s % 1 * 8)) {
    ...
    e.exports = function (e) {
        return c(e), e.baseURL && !s(e.url) && (e.url = a(e.baseURL, e.url)), e.headers = e.headers || {}, e.data = o(e.data, e.headers, e.transformRequest), e.headers = r.merge(e.headers.common || {}, e.headers[e.method] || {}, e.headers || {}), r.forEach(["delete", "get", "head", "post", "put", "patch", "common"], function (t) {
            delete e.headers[t]
